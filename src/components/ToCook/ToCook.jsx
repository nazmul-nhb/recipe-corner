...
const ToCook = ({ recipe, serial, handleCurrentlyCooking }) => {
    ...
    return (
        <tr>
            ...
            <td><button onClick={()=>handleCurrentlyCooking(recipe)} className="w-28 h-9 text-[#150B2B] rounded-[50px] font-medium text-base bg-[#0BE58A] border border-[#0BE58A] hover:text-[#0BE58A] hover:border-[#0BE58A] hover:bg-transparent mb-6">Preparing</button></td>
        </tr>
    );
};
