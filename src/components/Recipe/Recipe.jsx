...
const Recipe = ({ recipe, handleWantToCook }) => {
    ...
    return (
        <div className='flex flex-col justify-between gap-4 p-6 border border-[#28282833] rounded-2xl'>
            ...
            <button onClick={() => handleWantToCook(recipe)} className="w-44 h-12 text-[#150B2B] rounded-[50px] font-semibold text-lg bg-[#0BE58A] border border-[#0BE58A] hover:text-[#0BE58A] hover:border-[#0BE58A] hover:bg-transparent">Want to Cook</button>
        </div>
    );
};
