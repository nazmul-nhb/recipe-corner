    ...
    return (
        <div className="font-lexend mx-6 lg:mx-32 lg:mt-12 mt-6">
            <div className="max-w-[1600px] w-full h-auto mx-auto">
                <div className="w-full h-auto flex flex-col justify-center items-center gap-4 md:gap-8 bg-cover bg-center bg-no-repeat rounded-3xl text-center px-6 py-6 md:px-24 lg:px-48 md:py-16 lg:py-32" style={{ backgroundImage: `url(${banner})` }}>
                    <div className="">
