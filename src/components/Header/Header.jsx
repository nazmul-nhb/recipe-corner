...
const Header = () => {
    return (
        <header className="mx-0 md:mx-16 lg:mx-32 mt-3 md:mt-12">
            <div className="max-w-[1600px] font-lexend justify-between items-center navbar mx-auto">
                <div className="navbar-start">
                    ...
                    <a className="btn btn-ghost text-2xl md:text-4xl font-bold">Recipe Corner</a>
                </div>
                <div className="navbar-center hidden xl:flex justify-start text-[#150B2BB3]">
                ...
                <div className="flex justify-between gap-4">
                    <div className="hidden lg:flex flex-row items-center rounded-[50px] relative bg-[#150B2B0D]">
